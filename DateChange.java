...
public class DateChange 
{
	...
	/**
	 * Calculates the velocity required to travel t1 years into the future given a travel time of t2 years
	...
	/**
	 * Calculates the time that would pass on earth given your velocity and how much time passes for you
	...
	/**
	 * Calculates the time that would pass for you given your velocity and how much time passes on earth
	 * @param v velocity you are going
	...
	public void changeDate(double x)
	{
		...
		if(removeYear!=x)
		{
			...
			if(getYear()%4==0&&getYear()%100!=0&&getYear()==2&&getDay()>29)
			{
				addMonths(1);
				addDays(-29);
			}
			else if(getYear()%4==0&&getYear()%100==0&&getYear()%400==0&&getMonth()==2&&getDay()>29)
			{
				addMonths(1);
				addDays(-29);
			}
			else if(getDay()>30&&(getMonth()!=1&&getMonth()!=3&&getMonth()!=5&&getMonth()!=7&&getMonth()!=8&&
			...
			else if(getDay()>31&&(getMonth()==1||getMonth()==3||getMonth()==5||getMonth()==7||getMonth()==8||
					getMonth()==10||getMonth()==11))
			{
				addMonths(1);
				addDays(-31);
			...
			else if(getYear()%4!=0&&getYear()%100==0&&getYear()%400!=0&&getMonth()==2&&getMonth()==2&&getDay()>28)
			{
				addMonths(1);
				addDays(-28);
			}
